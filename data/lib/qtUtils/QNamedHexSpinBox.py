...
class QNamedHexSpinBox(QGridWidget):
    ...
    def init(app: QBaseApplication) -> None:
        ...
        QNamedHexSpinBox._mode_icons[0] = app.get_icon('hexspinbox/hex.png', True, QSaveData.IconMode.Global)
        QNamedHexSpinBox._mode_icons[1] = app.get_icon('hexspinbox/text.png', True, QSaveData.IconMode.Global)
