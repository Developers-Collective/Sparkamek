...
class ChoiceData(BaseSubItemData):
    ...
    def __init__(self, data: Choice, path: str) -> None:
        ...
        self._property_frame.layout_.addWidget(self._patchref_pages, 0, 0)
        ...
        subframe.layout_.addWidget(self._patchref_draglist, 1, 0)
        ...
        subframe.layout_.addWidget(self._add_patchref_entry_button, 2, 0)
