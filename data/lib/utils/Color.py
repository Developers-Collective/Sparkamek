...
class Color:
    ...
    @staticmethod
    def from_hexa(color: str) -> 'Color':
        return Color(color)

    @staticmethod
    def from_ahex(color: str) -> 'Color':
        c = Color()
        color.replace('#', '')
    ...
    def hex(self, hex: str) -> None:
        self.red, self.green, self.blue = Color.from_hex(hex).rgb
    ...
    def hexa(self, hexa: str) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_hexa(hexa).rgba
    ...
    def ahex(self, ahex: str) -> None:
        self.alpha, self.red, self.green, self.blue = Color.from_ahex(ahex).rgba
    ...
    def rgb(self, rgb: tuple[int, int, int]) -> None:
        self.red, self.green, self.blue = Color.from_rgb(rgb).rgb
    ...
    def rgba(self, rgba: tuple[int, int, int, int]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_rgba(rgba).rgba
    ...
    def argb(self, argb: tuple[int, int, int, int]) -> None:
        self.alpha, self.red, self.green, self.blue = Color.from_argb(argb).argb
    ...
    def hsv(self, hsv: tuple[int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue = Color.from_hsv(hsv).rgb
    ...
    def hsva(self, hsva: tuple[int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_hsva(hsva).rgba
    ...
    def hls(self, hls: tuple[int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue = Color.from_hls(hls).rgb
    ...
    def hlsa(self, hlsa: tuple[int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_hlsa(hlsa).rgba
    ...
    def hsl(self, hsl: tuple[int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue = Color.from_hsl(hsl).rgb
    ...
    def hsla(self, hsla: tuple[int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_hsla(hsla).rgba
    ...
    def yiq(self, yiq: tuple[int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue = Color.from_yiq(yiq).rgb
    ...
    def yiqa(self, yiqa: tuple[int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_yiqa(yiqa).rgba
    ...
    def cmyk(self, cmyk: tuple[int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue = Color.from_cmyk(cmyk).rgb
    ...
    def cmyka(self, cmyka: tuple[int|float, int|float, int|float, int|float, int|float]) -> None:
        self.red, self.green, self.blue, self.alpha = Color.from_cmyka(cmyka).rgba


    def _get_color_terminal(self, background: bool = False) -> str:
        return f'\033[{48 if background else 38};2;{self._red};{self._green};{self._blue}m'

    @classproperty
    def terminal_reset(cls) -> str:
        return '\033[0m'

    @property
    def terminal_color(self) -> int:
        return self._get_color_terminal(False)
    
    @property
    def terminal_background(self) -> int:
        return self._get_color_terminal(True)
#----------------------------------------------------------------------
